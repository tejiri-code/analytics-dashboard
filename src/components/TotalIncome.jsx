...
const TotalOrdersGraph = () => {
  ...
  return (
    <div className={` p-2 border rounded-lg shadow-md ${darkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
      ...
      <i className="fa-solid fa-coins fa-xl" style={{color: "#63E6BE",}} />
      </div>
      <div className='my-5'>
      ...
      <h2 className="text-xl text-gray-400 mb-2">Total Income</h2>
        <p className={`text-xl  mb-2 ${darkMode ? ' text-white' : 'text-black'}`}>$350.000</p>
        </div>
        <div className="flex justify-between  text-sm">
          <div className=' rounded-full w-20 text-center h-6 items-center justify-center bg-[#34CAA51F]'>
          <h5 className='text-[#34CAA5]'><i className="fa-solid fa-arrow-trend-up fa-sm" style={{color: "#34CAA5", padding:'2%',} } />23.5%</h5>
          </div>
