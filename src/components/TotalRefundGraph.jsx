...
const TotalOrdersGraph = () => {
  ...
  return (
    <div className={` p-2 border rounded-lg shadow-md ${darkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
      ...
      <i className="fa-solid fa-share-from-square fa-xl" style={{color: "#63E6BE",}} />
      </div>
      <div className='my-5'>
      ...
      <h2 className="text-xl text-gray-400 mb-2">Total Refund</h2>
        <p className={`text-xl  mb-2 ${darkMode ? ' text-white' : 'text-black'}`}>270</p>
        </div>
